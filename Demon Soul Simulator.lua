...
---[HwidCheck]
local HwidCheck= "1b64b06f-c266-44dc-af4c-8842a4793bf9" 
local HwidCheck1= "7541335D-5B74-4EA4-8A83-4CAFE971CFA0"
local HwidCheck2= "F6938B33-B1CA-481C-AD14-3C0AC486DA22"
local HwidCheck3= "8868fa58-68a0-4b3c-8755-1c4f10e4063a"
local HwidCheck4= "98fa7acc-5446-45a5-96cb-bd64ef4b9eec"
local HwidCheck5= "e3bb8142-ae6c-4738-991d-79fe3ad89915"
local HwidCheck6= "BF90EE5B-7ACB-4DCB-877E-2EA36134524B"
local HwidCheck7= "e3bb8142-ae6c-4738-991d-79fe3ad89915"
local HwidCheck8= "53797CDC-6711-4AE8-B761-99423094E0CC"
local HwidCheck9= "73205226-cd42-4252-ba3d-6fc4a63f61f7"
local HwidCheck10= "C74D1938-9A68-4C5E-90BF-06980B8F6006"
local HwidCheck11= "f04e964d-c510-4d0d-891f-87bf6acf8add"
---[HwidCheck]


if Key == "KAITO-5V4CY-FHY4A" then
    if DemonSoulSimulator then
		if Hwidplr == HwidCheck then --[Jean Nipat]
			u()
		else
			game.Players.LocalPlayer:Kick("Hi Use Key Buy Key or ซื้อ Key FB : Kaito Kung")
			wait(3)
			game.Players.LocalPlayer:Kick("อย่าโง่รันถ้า Hwid มึงไม่ตรง ซื้อ Key FB : Kaito Kung")
			wait(3)
			game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").LocalPlayer)
		end
    end
elseif Key == "KAITO-5V4CY-FHY4A1" then --[Kaito]
    if DemonSoulSimulator then
		if Hwidplr == HwidCheck1 then 
			u()
		else
			game.Players.LocalPlayer:Kick("Hi Use Key Buy Key or ซื้อ Key FB : Kaito Kung")
			wait(3)
...
elseif Key == "KAITO-5V4CY-FHY4A2" then --[เซนต์]
    Keychecked = true
    if DemonSoulSimulator then
        if Keychecked == true then
            if Hwidplr == HwidCheck2 then
                u()
            else
                game.Players.LocalPlayer:Kick("Hi Use Key Buy Key or ซื้อ Key FB : Kaito Kung")
                wait(3)
...
elseif Key == "KAITO-5V4CY-FHY4A3" then --[Donn Paripan ]
    Keychecked = true
    if DemonSoulSimulator then
        if Keychecked == true then
            if Hwidplr == HwidCheck3 then
                u()
            else
                game.Players.LocalPlayer:Kick("Hi Use Key Buy Key or ซื้อ Key FB : Kaito Kung")
                wait(3)
...
elseif Key == "KAITO-5V4CY-FHY4A4" then --[SN Ack]
    Keychecked = true
    if DemonSoulSimulator then
        if Keychecked == true then
            if Hwidplr == HwidCheck4 then
                u()
            else
                game.Players.LocalPlayer:Kick("Hi Use Key Buy Key or ซื้อ Key FB : Kaito Kung")
                wait(3)
...
elseif Key == "KAITO-5V4CY-FHY4A5" then --[]
    Keychecked = true
    if DemonSoulSimulator then
        if Keychecked == true then
            if Hwidplr == HwidCheck5 then
                u()
            else
                game.Players.LocalPlayer:Kick("Hi Use Key Buy Key or ซื้อ Key FB : Kaito Kung")
                wait(3)
...
elseif Key == "KAITO-5V4CY-FHY4A6" then --[]
    Keychecked = true
    if DemonSoulSimulator then
        if Keychecked == true then
            if Hwidplr == HwidCheck6 then
                u()
            else
                game.Players.LocalPlayer:Kick("Hi Use Key Buy Key or ซื้อ Key FB : Kaito Kung")
                wait(3)
...
elseif Key == "KAITO-5V4CY-FHY4A7" then --[]
    Keychecked = true
    if DemonSoulSimulator then
        if Keychecked == true then
            if Hwidplr == HwidCheck7 then
                u()
            else
                game.Players.LocalPlayer:Kick("Hi Use Key Buy Key or ซื้อ Key FB : Kaito Kung")
                wait(3)
...
elseif Key == "KAITO-5V4CY-FHY4A8" then --[]
    Keychecked = true
    if DemonSoulSimulator then
        if Keychecked == true then
            if Hwidplr == HwidCheck8 then
                u()
            else
                game.Players.LocalPlayer:Kick("Hi Use Key Buy Key or ซื้อ Key FB : Kaito Kung")
                wait(3)
...
elseif Key == "KAITO-5V4CY-FHY4A9" then --[]
    Keychecked = true
    if DemonSoulSimulator then
        if Keychecked == true then
            if Hwidplr == HwidCheck9 then
                u()
            else
                game.Players.LocalPlayer:Kick("Hi Use Key Buy Key or ซื้อ Key FB : Kaito Kung")
                wait(3)
...
elseif Key == "KAITO-5V4CY-FHY4A10" then --[]
    Keychecked = true
    if DemonSoulSimulator then
        if Keychecked == true then
            if Hwidplr == HwidCheck10 then
                u()
            else
                game.Players.LocalPlayer:Kick("Hi Use Key Buy Key or ซื้อ Key FB : Kaito Kung")
                wait(3)
...
elseif Key == "KAITO-5V4CY-FHY4A11" then --[]
    Keychecked = true
    if DemonSoulSimulator then
        if Keychecked == true then
            if Hwidplr == HwidCheck11 then
                u()
            else
                game.Players.LocalPlayer:Kick("Hi Use Key Buy Key or ซื้อ Key FB : Kaito Kung")
                wait(3)
...
elseif Key == nil or not Key then
    game.Players.LocalPlayer:Kick("มึงรันสคริปต์ผิดหาโคตรพ่อมึงหรอเดี๋ยวกูแบนแมร่ง ไอควายโง่จริงๆ")
    wait(3)
    game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").LocalPlayer)
end
